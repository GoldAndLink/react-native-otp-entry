...
exports.OtpInput = (0, react_1.forwardRef)((props, ref) => {
    ...
    return (<react_native_1.View style={[OtpInput_styles_1.styles.container, containerStyle]}>
      ...
      <react_native_1.TextInput value={text} onChangeText={handleTextChange} maxLength={numberOfDigits} inputMode="numeric" returnKeyType="done" ref={inputRef} autoFocus={autoFocus} style={OtpInput_styles_1.styles.hiddenInput} secureTextEntry={secureTextEntry} testID="otp-input-hidden"/>
    </react_native_1.View>);
});
